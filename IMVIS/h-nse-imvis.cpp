...
int lab1_opdracht1a_beeld_spiegelen() { // 1. Spiegelen 
    ...
    src = imread("C:/IMVIS/lab_materialen/lab1/Donker.pgm", IMREAD_GRAYSCALE);
...
int lab1_opdracht1a_beeld_inverten() { // 1. Spiegelen 
    Mat src, dst;
...
// 2. Zwart en wit tinten inverteren
    ...
    // Load original image
    src = imread("C:/IMVIS/lab_materialen/lab2/Rijswijk.pgm", IMREAD_GRAYSCALE);
...
int lab3_opdracht1_hoogdoorlaat()
{
    ...
    // Load original image
    src = imread("C:/IMVIS/lab_materialen/lab3/joint.jpg", IMREAD_GRAYSCALE);
...
int lab3_opdracht2a_laagdoorlaat()
{
    ...
    // Load original image
    src = imread("C:/IMVIS/lab_materialen/lab3/whalesp.jpg", IMREAD_GRAYSCALE);
...
int lab4_opdracht3_mieren() { // 10. Mier(en)
    ...
    int HEIGHT = src.rows;
    int WIDTH = src.cols;
    src = imread("C:/IMVIS/lab_materialen/lab4/ants1F.pgm", IMREAD_GRAYSCALE);
    src2 = imread("C:/IMVIS/lab_materialen/lab4/ants2F.pgm", IMREAD_GRAYSCALE);
...
int lab5_opdracht1_gaten_tellen() { // 11. Gaten tellen1
    // 11. Gaten tellen1
    Mat src;
    src = imread("C:/IMVIS/lab_materialen/lab5/chassis1.pgm", IMREAD_GRAYSCALE);
...
int lab5_opdracht2_labellen() { // 12. Gaten tellen2 - verbeterd
    ...
    Mat src;
    src = imread("C:/IMVIS/lab_materialen/lab5/chassis2.pgm", IMREAD_GRAYSCALE);

    Mat dst = Mat::ones(src.rows, src.cols, CV_8U) * 0;

    GatenBeter GatenBeter(src, dst);
    GatenBeter.process();
...
int main(int argc, const char** argv){
    ...
    do {
        ...
        cout << "-2: Lab 1 Opdracht 1a - Verticaal" << endl;
        cout << " 1: Lab 1 Opdracht 1a - Horizontaal" << endl;
        ...
        case -2: ret = lab1_opdracht1a_beeld_inverten(); break;
        case 0: ret = 0; break;
